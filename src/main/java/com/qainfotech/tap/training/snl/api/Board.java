...
public class Board {
	 ...
	 */
	public Board() throws FileNotFoundException, UnsupportedEncodingException, IOException {
	...
	/**
	 * adds new player to board Conditions: - Max players 4 - Players must have
	 * unique names on a board - All players are on initial position - 0th step
	 * 
	 * @param name
	 *            - player name
	 * @return JSONArray of registered players on the board with new player
	 *         added
	 * @throws PlayerExistsException
	 *             exception thrown when entered name parameter matches existing
	 *             players
	 * @throws GameInProgressException
	 *             exception thrown when we try to register on a board where
	 *             players have already started movement
	 * @throws MaxPlayersReachedExeption
	 *             exception thrown when we try to register more players than
	 *             allowed limit for board
	 * @throws FileNotFoundException
	 * @throws UnsupportedEncodingException
	 */
	public JSONArray registerPlayer(String name) throws PlayerExistsException, GameInProgressException,
	 ...
	 * 
	 * @param playerUuid
	 *            UUID of player which has to be deleted
	 * @return JSONArray of all existing players on the board
	 * @throws NoUserWithSuchUUIDException
	 *             raised when incorrect UUID is passed
	 * @throws FileNotFoundException
	 * @throws UnsupportedEncodingException
	 */
	public JSONArray deletePlayer(UUID playerUuid)
			throws NoUserWithSuchUUIDException, FileNotFoundException, UnsupportedEncodingException {
	...
	/**
	 * Roll the dice of the turn player and make move on the board per the
	 * outcome of the dice roll
	 * 
	 * @param playerUuid
	 *            UUID of player who has the turn
	 * @return JSONObject containing the outcome of dice, name and uuid of turn
	 *         player and a message specifying the move that was made by the
	 *         turn player
	...
	public JSONObject rollDice(UUID playerUuid)
			throws InvalidTurnException, FileNotFoundException, UnsupportedEncodingException {
