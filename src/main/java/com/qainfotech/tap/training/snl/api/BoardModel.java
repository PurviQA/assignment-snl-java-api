...
public class BoardModel {
	...
	public static void save(UUID uuid, JSONObject content) throws FileNotFoundException, UnsupportedEncodingException {
		PrintWriter writer = new PrintWriter(uuid.toString() + ".board", "UTF-8");
	...
	public static JSONObject data(UUID uuid) throws IOException {
		return new JSONObject(new String(Files.readAllBytes(Paths.get(uuid.toString() + ".board"))));
	}
}
